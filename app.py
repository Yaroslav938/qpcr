...
with st.sidebar:
    ...
    if uploaded_file is not None:
        try:
            # 1. Грузим сырой DF (Универсальная безопасная распаковка)
...
with tab_batch:
    ...
    if ds_b is not None:
        ...
        if st.button("Запустить Batch Fit", type="primary"):
            ...
            # Исправлено: аргумент называется model, а не model_choice
        ...
        if st.button("🚀 Запустить глобальный расчет", type="primary", key="multi_run"):
            ...
            try:
                for i, file in enumerate(uploaded_files):
                    ...
                    # Универсальная распаковка как и в основном потоке
                    ...
                    # Исправлено: model="auto", а не model_choice="auto"
